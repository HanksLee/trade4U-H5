...
import { SYMBOL_RESFRESH } from "pages/Symbol/config/messageCmd";
...
export default class Left extends BaseReact<{}, {}> {
          ...
          <TabPane tab={"产品"} key={"1"}>
            ...
            <div className={"symbol-sidebar custom-table"}>
              ...
              <WS_ProductList
                ...
                setOpenSymbol={this.setOpenSymbol}
  ...
  cancelTrackSymbolIdListener = autorun(() => {
    const { getOpenSymbolDetail } = this.props.product;

    if (this.product === null)
      return;
    this.props.common.setMessage({
      cmd: SYMBOL_RESFRESH,
      data: getOpenSymbolDetail
    });
  });

  cancelTrackMessageListener = autorun(() => {
    const { message } = this.props.common;
